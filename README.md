...
| [`@erboladaiorg/vero-fuga`](./packages/api-clients/storefront-api-client/#readme) | [![Latest badge](https://img.shields.io/npm/v/@erboladaiorg/vero-fuga/latest.svg)](https://www.npmjs.com/package/@erboladaiorg/vero-fuga) | Client for the GraphQL [Storefront](https://shopify.dev/docs/api/storefront) API.                                                    |
